...
from src.common import load_training_data, print_regression_metrics
from regression.bias_svr_linear.src.model import build_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train TF-IDF + Linear SVR political bias regressor")
    ...
    parser.add_argument("--model-out", default="models/bias_svr_linear.joblib")
...
def main() -> None:
    ...
    model = build_model(c=args.c, epsilon=args.epsilon, random_state=args.random_state)
