...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Predict political bias score with TF-IDF + Ridge")
    parser.add_argument("--model", default="models/bias_ridge_tfidf.joblib")
