...
from regression.experiments.bias_gbdt_tfidf_regression.src.model import build_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train TF-IDF/SVD + GBDT political bias regressor")
    ...
    parser.add_argument("--model-out", default="models/bias_gbdt_tfidf_regression.joblib")
