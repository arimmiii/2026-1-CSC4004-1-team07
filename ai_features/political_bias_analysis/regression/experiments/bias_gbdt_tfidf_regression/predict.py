...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Predict political bias score with TF-IDF/SVD + GBDT")
    parser.add_argument("--model", default="models/bias_gbdt_tfidf_regression.joblib")
