...
from classification.experiments.bias_svm_kernel_approx.src.model import build_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train kernel-approx SVM political bias classifier")
    ...
    parser.add_argument("--model-out", default="models/bias_svm_kernel_approx.joblib")
