...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Predict political bias class with TF-IDF + Linear SVM")
    parser.add_argument("--model", default="models/bias_svm_linear.joblib")
