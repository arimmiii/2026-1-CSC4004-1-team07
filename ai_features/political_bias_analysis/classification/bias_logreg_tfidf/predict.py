...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Predict political bias class with TF-IDF + Logistic Regression")
    parser.add_argument("--model", default="models/bias_logreg_tfidf.joblib")
