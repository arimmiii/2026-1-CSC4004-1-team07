...
from classification.bias_logreg_tfidf.src.model import build_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train TF-IDF + Logistic Regression political bias classifier")
    ...
    parser.add_argument("--model-out", default="models/bias_logreg_tfidf.joblib")
